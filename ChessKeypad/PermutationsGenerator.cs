...
public class PermutationsGenerator
{
    ...
    private static int CalculatePermutations(int numberOfDigits, int position, Coordinate start, Cell cell, Dictionary<Coordinate, List<(Coordinate Coordinate, Cell Cell)>> validMoves)
    {
